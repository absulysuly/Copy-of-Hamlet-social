...
export const MOCK_USERS: User[] = [
    { id: 'user1', name: 'Ahmed Al-Iraqi', email: 'ahmed.iraqi@example.com', emailVerified: true, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user1/150/150', verified: true, party: 'حزب تقدم', governorate: 'Baghdad', isElected: true, bio: 'Striving for a better Baghdad. Focused on infrastructure and youth employment.', partySlug: 'taqadum-party', governorateSlug: 'baghdad' },
    { id: 'user2', name: 'Fatima Al-Basri', email: 'fatima.basri@example.com', emailVerified: true, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user2/150/150', verified: true, party: 'تحالف عزم العراق / عزم', governorate: 'Basra', bio: 'Economist and activist, working to bring economic prosperity to Basra.', partySlug: 'azm-alliance-iraq', governorateSlug: 'basra' },
    { id: 'user3', name: 'Yusuf Al-Mosuli', email: 'yusuf.mosuli@example.com', emailVerified: false, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user3/150/150', verified: false, party: 'ائتلاف دولة القانون', governorate: 'Nineveh', bio: 'Dedicated to rebuilding our communities and fostering unity.', partySlug: 'state-of-law-coalition', governorateSlug: 'ninawa' },
    { id: 'user4', name: 'Layla Al-Erbili', email: 'layla.erbili@example.com', emailVerified: true, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user4/150/150', verified: true, party: 'الحزب الديمقراطي الكوردستاني', governorate: 'Erbil', isElected: false, bio: 'Championing modern education and technology for the next generation.', partySlug: 'kurdistan-democratic-party', governorateSlug: 'erbil' },
    { id: 'user5', name: 'Omar Al-Anbari', email: 'omar.anbari@example.com', emailVerified: false, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user5/150/150', verified: false, party: 'Independent', governorate: 'Anbar', bio: 'An independent voice for the people of Anbar.', partySlug: 'independent', governorateSlug: 'anbar' },
    { id: 'user6', name: 'Zahra Al-Najafi', email: 'zahra.najafi@example.com', emailVerified: true, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user6/150/150', verified: false, party: 'تحالف قوى الدولة الوطنية', governorate: 'Najaf', bio: 'Working to improve healthcare and social services.', partySlug: 'alliance-of-national-state-forces', governorateSlug: 'najaf' },
    { id: 'user7', name: 'Amir Al-Sadr', email: 'amir.sadr@example.com', emailVerified: true, role: UserRole.Candidate, avatarUrl: 'https://picsum.photos/seed/user7/150/150', verified: true, party: 'حركة الصادقون', governorate: 'Basra', bio: 'Leading the movement for a sovereign Iraq.', partySlug: 'al-sadiqoun-movement', governorateSlug: 'basra' },
    { id: 'voter1', name: 'Ali Hussein', email: 'ali.hussein@example.com', emailVerified: true, role: UserRole.Voter, avatarUrl: 'https://picsum.photos/seed/voter1/150/150', verified: false, party: 'N/A', governorate: 'Baghdad' },
    { id: 'voter2', name: 'Noor Khalid', email: 'noor.khalid@example.com', emailVerified: false, role: UserRole.Voter, avatarUrl: 'https://picsum.photos/seed/voter2/150/150', verified: false, party: 'N/A', governorate: 'Basra' },
];
