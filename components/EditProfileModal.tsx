        ...
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center backdrop-blur-sm p-4" onClick={onClose}>
            ...
            >
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="avatarUrl" className="block text-sm font-medium text-slate-300">Avatar Image URL</label>
                        <input
                            type="text"
                            id="avatarUrl"
                            value={avatarUrl}
                    ...
                    <div>
                        <label htmlFor="bio" className="block text-sm font-medium text-slate-300">Biography</label>
                        <textarea
                            id="bio"
                            value={bio}
                ...
                <div className="mt-6 flex justify-end space-x-3">
                    <button
                        onClick={onClose}
                        className="px-4 py-2 text-sm font-semibold text-slate-800 bg-slate-300 rounded-md hover:bg-slate-400"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={handleSave}
                        className="px-4 py-2 text-sm font-semibold text-white bg-brand-hot-pink rounded-full transition-all hover:brightness-110"
                    >
                        Save Changes
                    </button>
                </div>
